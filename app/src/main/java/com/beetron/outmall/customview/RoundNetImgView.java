 ...
 * Time: 21:20.
 */
public class RoundNetImgView extends NetworkImageView {
    ...
    public static final String TAG = RoundNetImgView.class.getSimpleName();
    ...
    public RoundNetImgView(Context context) {
        super(context);
    }

    public RoundNetImgView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundNetImgView(Context context, AttributeSet attrs, int defStyle) {
