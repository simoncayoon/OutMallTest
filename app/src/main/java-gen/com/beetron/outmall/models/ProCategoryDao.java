...
/** 
 * DAO for table "PRO_CATEGORY".
*/
public class ProCategoryDao extends AbstractDao<ProCategory, Void> {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PRO_CATEGORY\" (" + //
                "\"ID\" TEXT," + // 0: id
                "\"NAME\" TEXT," + // 1: name
                "\"STANK\" TEXT);"); // 2: stank
    }
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PRO_CATEGORY\"";
        db.execSQL(sql);
    }
    ...
    /** @inheritdoc */
    @Override
    public ProCategory readEntity(Cursor cursor, int offset) {
        ProCategory entity = new ProCategory( //
            cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0), // id
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // name
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // stank
        );
        return entity;
    }
